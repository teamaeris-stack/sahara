...
Citizen Home is the default screen.
Mobile design is polished.
Disaster Mode banner is visible.
ONLINE/OFFLINE demo toggle works.
Network state survives refresh.
OFFLINE mode clearly says “ResQ is still working.”
I’M SAFE works.
SAFE status survives refresh.
CAN’T RESPOND status works and survives refresh.
I NEED HELP does not crash and opens its temporary Phase 2 panel.
Secondary feature cards do not lead to empty/broken pages.
Bottom navigation works safely.
Reset Demo Data works.
There are no external API/backend requirements.
There are no console-breaking errors.
There is no horizontal overflow on mobile.
No advanced feature from later phases has been unnecessarily implemented.
==================================================
IMPORTANT
==================================================
